...
#ifndef TENSORFLOW_CONTRIB_TENSOROPT_SEGMENT_UNION_FIND_H_
#define TENSORFLOW_CONTRIB_TENSOROPT_SEGMENT_UNION_FIND_H_
...
class UnionFind {
 public:
  ...
  UnionFind(const T& v) : size_(1), parent_(nullptr), value_(v) {}
...
#endif  // TENSORFLOW_CONTRIB_TENSOROPT_SEGMENT_UNION_FIND_H_
