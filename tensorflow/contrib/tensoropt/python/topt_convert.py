...
# =============================================================================
"""Exposes the Python wrapper conversion to topt_graph."""
...
import six as _six
import numpy as np
from tensorflow.contrib.tensoropt.wrap_conversion import topt_convert
...
def create_inference_graph(input_graph_def,
  ...
  """Python wrapper for the TOPT transformation.
  ...
  Args:
    ...
    minimum_segment_size: the minimum number of nodes required for a subgraph to
      be replaced by TOPTEngineOp.

  Returns:
    New GraphDef with TOPTEngineOps placed in graph replacing subgraphs.
  ...
  out = topt_convert(input_graph_def_str, out_names, max_batch_size,
